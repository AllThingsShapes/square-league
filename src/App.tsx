...
const App: React.FC = () => {
  ...
  const seasonData: SeasonData = {
    ...
    [season3]: {
      squares: [
        { id: 1, color: "red", name: "Red", wins: 3, losses: 1, draws: 0, power_ups: 85, damage_done: 211, wall_bounces: 617, image: "https://docs.google.com/drawings/d/e/2PACX-1vTc2C286DHcGfC_czwyyZlEX-oWNFd7fDhc2LrbTrEyQgHYhK-MfNT821xsGg69h9MB2lSEiplNyKzr/pub?w=1500&h=1500" },
        { id: 2, color: "blue", name: "Blue", wins: 1, losses: 3, draws: 0, power_ups: 65, damage_done: 216, wall_bounces: 603, image: "https://docs.google.com/drawings/d/e/2PACX-1vSsaPN03rGs7PGXG9xTw-2f8pZ244MIRSTQraWvHPvQYlymKBDiyVeYS1HCDiSRgfma2pTqY-ZZrjnn/pub?w=1500&h=1500" },
        { id: 3, color: "green", name: "Green", wins: 0, losses: 4, draws: 0, power_ups: 41, damage_done: 197, wall_bounces: 429, image: "https://docs.google.com/drawings/d/e/2PACX-1vRBDNIxSyjWmPTeqDWfYJt2vgg3lMIzlI1NwRWHYhv0kRdOAYToxthvUxBTNtTutO4pwrbHe3uPxE9-/pub?w=1500&h=1500" },
        { id: 4, color: "yellow", name: "Yellow", wins: 2, losses: 2, draws: 0, power_ups: 114, damage_done: 261, wall_bounces: 671, image: "https://docs.google.com/drawings/d/e/2PACX-1vREnIoNxanMIqNNa97QvURbVm6lesZVxvq-awFhaZb0q608Yon95qTM8BHHReB8hryih7kVEx-i4kTj/pub?w=1500&h=1500" },
        { id: 5, color: "purple", name: "Purple", wins: 1, losses: 3, draws: 0, power_ups: 75, damage_done: 215, wall_bounces: 553, image: "https://docs.google.com/drawings/d/e/2PACX-1vRyYszxA7ij21DNmKRGIvyvBWxJ68V8_B0LAFiLszo6NyaRWdfYggCrbMDrwoJrFI0qEBn4jKvIKidN/pub?w=1500&h=1500" },
        { id: 6, color: "hot_pink", name: "Hot Pink", wins: 4, losses: 0, draws: 0, power_ups: 113, damage_done: 259, wall_bounces: 659, image: "https://docs.google.com/drawings/d/e/2PACX-1vRjCF0SICdWi0Z4hf54U6M19P-5t7BTlCDQwQXYVeE79rH1yumBW0UiP3bL8qMuPppxZ84iUwlHqQsA/pub?w=1500&h=1500" },
        { id: 7, color: "cyan", name: "Cyan", wins: 2, losses: 2, draws: 0, power_ups: 100, damage_done: 210, wall_bounces: 644, image: "https://docs.google.com/drawings/d/e/2PACX-1vS68NgAs3PWllP4Py9vS_Y0ANxvtvpkp3iIzBkgKLegtzei_NTMU_VIaB5G60qADiDiulqJbaU2l6AY/pub?w=1500&h=1500" },
        { id: 8, color: "orange", name: "Orange", wins: 3, losses: 1, draws: 0, power_ups: 67, damage_done: 215, wall_bounces: 492, image: "https://docs.google.com/drawings/d/e/2PACX-1vT5u4pAKWj6yg0XmzqHLlL1vRibnYNYolMZwZk8a6bKQOXU0UAgCiSvkK23St_60VkGu01oAhMlSMNT/pub?w=1500&h=1500" },
        { id: 9, color: "arctic", name: "Arctic", wins: 1, losses: 3, draws: 0, power_ups: 76, damage_done: 253, wall_bounces: 620, image: "https://docs.google.com/drawings/d/e/2PACX-1vTyYJ8Hg0GP4PbaTlJJY6dvmjclMrEX9G3EFgctOHOwO_pYHobBpRfrAoNOQs9wf3NRwcHe_1C0_qqO/pub?w=1500&h=1500" },
        { id: 10, color: "crimson", name: "Crimson", wins: 1, losses: 3, draws: 0, power_ups: 96, damage_done: 213, wall_bounces: 611, image: "https://docs.google.com/drawings/d/e/2PACX-1vQo89c923T011Exxd5CZTXxX09kwRgd9TwTJG_8FsRv6FwVUIsrD-ezVywX6mjHtQAFA7VNPOniXKym/pub?w=1500&h=1500" },
        { id: 11, color: "cerulean", name: "Cerulean", wins: 4, losses: 0, draws: 0, power_ups: 87, damage_done: 228, wall_bounces: 559, image: "https://docs.google.com/drawings/d/e/2PACX-1vRAkxvHOfwQzadYbbhXZTS17_fau8ibD4DBZR6MtEjcMvw8sbTGpnl3uZWb864HHpV0MIyruXVx1Y4l/pub?w=1500&h=1500" },
        { id: 12, color: "emerald", name: "Emerald", wins: 3, losses: 1, draws: 0, power_ups: 111, damage_done: 260, wall_bounces: 657, image: "https://docs.google.com/drawings/d/e/2PACX-1vRbLwinQ8ahVv3OGlXzrEkdMbaIDZf_eLltw8YpEq3yHm0HpJR6uxm4KyINR0cV8dQDXdxs2EcWfdK2/pub?w=1500&h=1500" },
        { id: 13, color: "goldenrod", name: "Goldenrod", wins: 2, losses: 2, draws: 0, power_ups: 112, damage_done: 264, wall_bounces: 676, image: "https://docs.google.com/drawings/d/e/2PACX-1vTHsaByxlGzycaF8E1vCkoTBUjpg9S0z_c94UTLx5crz6BBOryMVJWMFJqeyDhhNIL9rBZhVwXmZXrc/pub?w=1500&h=1500" },
        { id: 14, color: "diamond", name: "Diamond", wins: 0, losses: 4, draws: 0, power_ups: 86, damage_done: 257, wall_bounces: 639, image: "https://docs.google.com/drawings/d/e/2PACX-1vTwIEKDfpQJqOzx562jQRB1VHpHkcJKoTdodLni9ktC4cbJw11LcgjwsymNy49METDwq6R2WC3HBBrs/pub?w=1500&h=1500" },
        { id: 15, color: "coral", name: "Coral", wins: 2, losses: 2, draws: 0, power_ups: 91, damage_done: 225, wall_bounces: 627, image: "https://docs.google.com/drawings/d/e/2PACX-1vQbducBA_Enj_BCwFoMJ2e8Ww5xjphDDcdvn1aiORFS_gHqN7GR6dLRu2s_cg4Ni7a3cpyE742COvCI/pub?w=1500&h=1500" },
        { id: 16, color: "olive", name: "Olive", wins: 3, losses: 1, draws: 0, power_ups: 90, damage_done: 258, wall_bounces: 703, image: "https://docs.google.com/drawings/d/e/2PACX-1vRCGsClW8b5VReXMmoMkYbInPAhhTLDa3FZ8XVtVMj5gPWVB88--lbIHqLjEnkdn44tC-ME5D5H3DtN/pub?w=1500&h=1500" },
        { id: 17, color: "navy", name: "Navy", wins: 1, losses: 3, draws: 0, power_ups: 77, damage_done: 211, wall_bounces: 575, image: "https://docs.google.com/drawings/d/e/2PACX-1vQgfmkSvE4l86IUnoTlw74lqOJHAMQFCNB3aUvSrv9aQEgRJJHFSnVOVyEhK9FImPgwyjSrP3isEeyq/pub?w=1500&h=1500" },
        { id: 18, color: "teal", name: "Teal", wins: 4, losses: 0, draws: 0, power_ups: 103, damage_done: 254, wall_bounces: 637, image: "https://docs.google.com/drawings/d/e/2PACX-1vSxyKt3BBFxgp2rO9JoCyywMO3ZjHBGreXk4aLjjgZwEtsjfBSuhhBD31Ctx7_FWYK-3Go4IwHcPLho/pub?w=1500&h=1500" },
        { id: 19, color: "indigo", name: "Indigo", wins: 1, losses: 3, draws: 0, power_ups: 69, damage_done: 200, wall_bounces: 485, image: "https://docs.google.com/drawings/d/e/2PACX-1vSVQ47ut4IDgMSXXw0y3GZ02If5JwZJSDn_AbU3fC5756E5RBoHjSqDsCv8RPT5Tnu7WLPeNk6lq1rZ/pub?w=1500&h=1500" },
        { id: 20, color: "tan", name: "Tan", wins: 2, losses: 2, draws: 0, power_ups: 81, damage_done: 217, wall_bounces: 492, image: "https://docs.google.com/drawings/d/e/2PACX-1vS3F3SuNL4lWFNZEk26R1JCGncX8n3OHBSNSqHFWOaqHlQR5ZoBkDghSDDxZ6nw1bevyQsMIs6Oupso/pub?w=1500&h=1500" },
      ]
    }
  };
